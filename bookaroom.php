				...
				<div class="row">
					...
					<div class="mt-0">
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-providno d-flex p-1 mb-1" id="navOnScroll">
							...
							<form class="list-unstyled mr-auto collapse navbar-collapse" id="navbarBooking" action="checknow.php" method="GET">
								<div class="row">
								<div class="col-sm-4 col-lg-3">
										<div class="input-group date mg-check-in sel">
											<div class="input-group-addon"><i class="far fa-calendar-alt"></i></div>
											<input class="form-control sel" type="date" name="d1" placeholder="Check In" autocomplete="off">
										</div>
									</div>
									<div class="col-sm-4 col-lg-3">
										<div class="input-group date mg-check-out sel">
											<div class="input-group-addon"><i class="far fa-calendar-alt"></i></div>
											<input class="form-control sel" type="date" name="d2" placeholder="Check Out" autocomplete="off">
										</div>
									</div>
											<div class="col-sm-3 col-lg-1">
												<select class="cs-select cs-skin-elastic p-2 ml-1 mr-5 sel" name="broj-gostiju">
									...
									<button class="btn btn-main btn-block sel bg-light text-dark-50 book-btn" type="submit">Check Now</button>
									</div>
								</div>
